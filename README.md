...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
  A: A relational database is the format in which the data is organized. SQL is a language used to manipulate that data.

- [ ] Why do tables need a `primary key`?
  A: A primary key is a unique ID that refers to a piece of data in a database

- [ ] What is the name given to a table column that references the primary key on another table.
  A: A foreign key.

- [ ] What do we need in order to have a _many to many_ relationship between two tables.
  A: ternay table that contains the foreign keys of both tables, linking the tables together.
